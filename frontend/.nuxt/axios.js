...
export default (ctx, inject) => {
  ...
  const baseURL = process.browser
    ? (runtimeConfig.browserBaseURL || runtimeConfig.baseURL || 'http://1b6acd07ce16.ngrok.io')
      : (runtimeConfig.baseURL || process.env._AXIOS_BASE_URL_ || 'http://1b6acd07ce16.ngrok.io')
