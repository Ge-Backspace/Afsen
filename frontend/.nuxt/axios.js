...
export default (ctx, inject) => {
  ...
  const baseURL = process.browser
    ? (runtimeConfig.browserBaseURL || runtimeConfig.baseURL || 'http://9ce3934e9c07.ngrok.io')
      : (runtimeConfig.baseURL || process.env._AXIOS_BASE_URL_ || 'http://9ce3934e9c07.ngrok.io')
