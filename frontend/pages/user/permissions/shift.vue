...
export default {
  ...
  mounted() {
    ...
    this.$axios.get(`/getEmployee?user_id=${this.user_id}`).then((resp) => {
      this.form.employee1_id = resp.data.data.id;
      this.$store.dispatch("option/getOptionShiftEmployee1", {
        employee_id: this.form.employee1_id,
      });
    });
    this.$store.dispatch("shiftpermission/getUser", {
  ...
  methods: {
    searchData() {
      this.$store.dispatch("shiftemployee/getUser", {
        search: this.search,
        user_id: this.user_id,
      });
    },
    edit(data) {
      ...
      this.form.employee2_id = data.employee2_id;
      this.form.shift_employee1_id = data.shift_employee1_id;
      this.form.shift_employee2_id = data.shift_employee2_id;
      this.form.reason = data.reason;
      this.seDialog = true;
      this.optionshift2 = true;
