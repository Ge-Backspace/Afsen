  ...
  <div>
    ...
    <div class="container-fluid mt--7">
      <el-card v-loading="getLoader" style="margin-top: 120px">
        <div class="row">
          <div class="col-xl-4">
            <router-link to="/admin/company/asset">
              <vs-card type="4">
                <template #title>
                  <h3>Asset</h3>
                </template>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/reprimand">
              <vs-card type="4">
                <template #title>
                  <h3>Reprimand</h3>
                </template>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/task">
              <vs-card type="4">
                <template #title>
                  <h3>Task</h3>
                </template>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/announcement">
              <vs-card type="4">
                <template #title>
                  <h3>Announcement</h3>
                </template>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/user_activity_log">
              <vs-card type="4">
                <template #title>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/onboarding">
              <vs-card type="4">
                <template #title>
                  <h3>Onboarding</h3>
                </template>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/files">
              <vs-card type="4">
                <template #title>
                  <h3>Files</h3>
                </template>
          ...
          <div class="col-xl-4">
            <router-link to="/admin/company/polling">
              <vs-card type="4">
                <template #title>
                  <h3>Polling</h3>
                </template>
