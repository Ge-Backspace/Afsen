    ...
    <div class="header bg-primary pb-6" style="z-index:-1">
      <div class="container-fluid">
        <div class="header-body">
          <!-- Card stats -->
          <h1 class="heading">Data Asset Karyawan</h1>
        </div>
      </div>
    </div>
    <div class="container-fluid mt--7">
      <div class="row">
        <div class="col-md-12">
          ...
          <vs-button success style="float:right" :loading="globalLoader" gradient @click="downloadFile(`/lapor/download/xlsx`)">Import Excel</vs-button>
        </div>
      </div>
      <el-card v-loading="getLoader">
        <div class="row" style="margin-bottom:20px">
          <div class="col-md-4">
            <el-select size="mini" clearable filterable v-model="searchGoverment" @change="searchData()" placeholder="Job Position" style="width:100%">
        ...
        <vs-table striped>
          <template #thead>
            <vs-tr>
              <vs-th>Karyawan</vs-th>
              <vs-th>Asset Kategory</vs-th>
              <vs-th>Serial Number</vs-th>
              <vs-th>Description</vs-th>
              <vs-th>Lend Date</vs-th>
              <vs-th>Returned Date</vs-th>
            </vs-tr>
          </template>
          <template #tbody>
    ...
    <vs-dialog v-model="tambahDialog" :width="$store.state.drawer.mode === 'mobile' ? '80%' : '60%'"
      ...
      <div class="con-form">
        <vs-row>
          ...
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="6" style="padding:5px">
            <label>Holder</label>
            <vs-select filter placeholder="Choose The Employee" v-model="form.pelaksana_kegiatan">
