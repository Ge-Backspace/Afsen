    ...
    <div class="container-fluid mt--7">
      ...
      <el-card v-loading="getLoader">
        <div class="row" style="margin-bottom:20px">
          ...
          <div class="col-md-4">
            <el-select size="mini" clearable filterable v-model="searchGoverment" @change="searchData()" placeholder="Pilih Status Task" style="width:100%">
        ...
        <vs-table striped>
          <template #thead>
            <vs-tr>
              ...
              <vs-th>Assigner Status</vs-th>
              <vs-th>Assigned Status</vs-th>
              <vs-th>Message</vs-th>
              <vs-th>Action</vs-th>
            </vs-tr>
          </template>
      ...
      <div class="con-form">
        <vs-row>
          ...
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="6" style="padding:5px">
            <label>Title</label>
            <vs-input type="text" v-model="form.judul" placeholder="Title"></vs-input>
          </vs-col>
          <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="6" style="padding:5px">
          ...
          <vs-col
            ...
            style="padding: 5px"
          >
            <el-checkbox v-model="checked">Send Email</el-checkbox>
          </vs-col>
        </vs-row>
      </div>
