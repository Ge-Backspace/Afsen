...
class CutiEmployeeExport implements FromCollection, WithHeadings, WithEvents
{
    ...
    public function collection()
    {
        ...
        ->get(['employees.name', 'cutis.cuti_name', 'cutis.code', 'cuti_permissions.start_date', 'cuti_permissions.expired_date']);
    }
